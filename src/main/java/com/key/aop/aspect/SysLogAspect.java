package com.key.aop.aspect;

import com.alibaba.fastjson.JSON;
import com.key.aop.annotation.MyLog;
import com.key.constant.Constant;
import com.key.entity.SysLog;
import com.key.mapper.SysLogMapper;
import com.key.utils.HttpContextUtils;
import com.key.utils.IPUtils;
...
public class SysLogAspect {
     ...
     * 只要出现 @MyLog注解都会进入
     */
    @Pointcut("@annotation(com.key.aop.annotation.MyLog)")
